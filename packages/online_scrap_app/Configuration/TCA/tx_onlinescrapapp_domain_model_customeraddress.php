...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:online_scrap_app/Resources/Private/Language/locallang_db.xlf:tx_onlinescrapapp_domain_model_customeraddress',
        'label' => 'customer_id',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_onlinescrapapp_domain_model_customeraddress}.{#pid}=###CURRENT_PID### AND {#tx_onlinescrapapp_domain_model_customeraddress}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'customer_id' => [
            'exclude' => true,
            'label' => 'LLL:EXT:online_scrap_app/Resources/Private/Language/locallang_db.xlf:tx_onlinescrapapp_domain_model_customeraddress.customer_id',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
        ...
        'phone' => [
            'exclude' => true,
            'label' => 'LLL:EXT:online_scrap_app/Resources/Private/Language/locallang_db.xlf:tx_onlinescrapapp_domain_model_customeraddress.phone',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
        ...
        'city' => [
            'exclude' => true,
            'label' => 'LLL:EXT:online_scrap_app/Resources/Private/Language/locallang_db.xlf:tx_onlinescrapapp_domain_model_customeraddress.city',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
